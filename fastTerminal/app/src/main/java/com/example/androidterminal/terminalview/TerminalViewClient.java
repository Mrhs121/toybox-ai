...
public interface TerminalViewClient {
    ...
    boolean onKeyDown(int keyCode, KeyEvent e, SshTerminalSession session);
    ...
    boolean onCodePoint(int codePoint, boolean ctrlDown, SshTerminalSession session);


    void onEmulatorSet();

    void onMouseSecondaryClick(MotionEvent event, SshTerminalSession session);
